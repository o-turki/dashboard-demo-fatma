...
$query = "SELECT DISTINCT pack_num, pack_qte FROM `p4_pack_operation` WHERE prod_line LIKE '%ISA201%' AND cur_date = '03/02/2023'" ;
...
$query2 = "SELECT DISTINCT pack_num, qte_fp, qte FROM `p12_control` WHERE prod_line LIKE '%ISA201%' AND cur_day = '03/02/2023'" ;
...
$query3 = "SELECT operator_reg_num, prod_line, performance FROM `p8_op_performance_h` WHERE prod_line LIKE '%ISA201%' AND cur_date = '03/02/2023'" ;
...
$query4 = "SELECT DISTINCT operator_reg_num, prod_line FROM `p5_presence` WHERE cur_date = '03/02/2023' AND prod_line LIKE '%ISA201%'" ;
